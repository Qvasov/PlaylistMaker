...
import com.practicum.playlistmaker.searchview.Track
...
class SearchActivity : AppCompatActivity() {
    ...
    private val trackList = listOf(
        Track("Smells Like Teen Spirit Smells Like Teen Spirit Smells Like Teen Spirit", "Nirvana", "5:01",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val trackListView = findViewById<RecyclerView>(R.id.trackList)
